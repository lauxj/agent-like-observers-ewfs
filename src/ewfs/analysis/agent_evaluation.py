...
# directories
PAPER_DATA_DIR = PROJECT_ROOT / "data" / "paper_data"
DATA_DIR_NOISELESS = PAPER_DATA_DIR / "noiseless_simulation"
DATA_DIR_FAKE = PAPER_DATA_DIR / "fake_hardware"
DATA_DIR_REAL = PAPER_DATA_DIR / "real_hardware"
PLOTS_ROOT = PROJECT_ROOT / "results" / "plots" / "plots_agent_evaluation"

# -----------------------------------------------------------------------------
# Configuration

# Number of runs to aggregate per backend. These are selected from
# data/paper_data, so local test runs outside that folder do not enter the
# thesis/reproducibility plots.
EVALUATION_LAST_N = {
    "Noiseless": 10,
    "Fake hardware": 10,
    "Real hardware": 10,
...
def resolve_lf_result_paths(run_dirs, result_filename: str):
    del result_filename
...
def load_backend_result(
    ...
    lf_result_paths = resolve_lf_result_paths(run_dirs, result_filename)
